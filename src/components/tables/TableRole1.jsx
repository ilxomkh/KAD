            ...
            <tbody className="text-gray-700 text-sm rounded-3xl overflow-hidden">
              {paginatedData.map((item, index) => (
                ...
                >
                  ...
                  <td className="py-4 px-2 bg-white text-center font-semibold w-40 transition-colors duration-500 group-hover:text-blue-500">
                    {item.kadasterId}
                  </td>
                  ...
                  <td
                    className={`py-4 px-6 bg-white font-medium ${
