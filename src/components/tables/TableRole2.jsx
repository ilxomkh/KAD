    ...
    <div className="p-6 bg-[#e4ebf3] rounded-xl">
          ...
          <tbody className="text-gray-700 text-sm md:text-base">
            {data.map((item, index) => (
              ...
              >
                ...
                <td className="py-4 px-2 bg-white text-center">
                  <span className={`font-semibold ${item.status === "geometry_fixed" ? "text-green-500" : "text-red-500"}`}>
                    {item.status}
                  </span>
                </td>
      ...
      <div className="bg-[#f9f9f9] py-4 rounded-b-3xl">
        <Pagination
          ...
          itemsPerPage={10} // Используем значение из meta.pageSize, если оно динамическое
