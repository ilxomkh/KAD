          ...
          <div className="px-6">
            ...
            <tbody className="text-gray-700 text-sm rounded-3xl overflow-hidden">
              {paginatedData.map((item, index) => (
                ...
                >
                  <td className="py-4 px-2 text-center bg-white rounded-l-3xl font-semibold w-8">
                    {(currentPage - 1) * itemsPerPage + index + 1}.
                  </td>
                  <td className="py-4 px-2 text-center font-semibold bg-white w-40 transition-colors duration-500 group-hover:text-blue-500">
                    {item.kadasterId}
                  </td>
                  <td className="py-4 px-2 text-center bg-white font-bold w-24">
                    {item.modda}
                  </td>
                  <td className="py-4 px-2 text-center bg-white w-32">{item.region}</td>
                  <td className="py-4 px-2 text-center bg-white w-32">
                    {item.district}
                  </td>
                  <td className="py-4 px-2 text-center bg-white w-52">{item.address}</td>
                  <td className="py-4 px-2 text-center bg-white w-44">
                    {item.spaceImageId}
                  </td>
                  <td className="py-4 px-2 text-center bg-white w-32">
                    {item.spaceImageDate}
                  </td>
                  <td className="py-4 px-2 text-center bg-white w-24">
                    {item.category}
                  </td>
                  <td className="py-4 px-2 text-center bg-white w-32">
                    {item.arrivalDate}
                  </td>
                  <td className="py-4 px-2 text-orange-500 bg-white font-semibold text-center w-24">
                    {item.deadline}
                  </td>
