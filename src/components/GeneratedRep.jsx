  ...
  const downloadReport = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `${BASE_URL}/api/cadastre/${item.ID}/generated_report`,
        {
          method: "GET",
          headers: {
      ...
      link.download = item.generatedReport || "generated_report.pdf";
